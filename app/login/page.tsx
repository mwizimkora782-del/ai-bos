...
export default function Login() {
  ...
  // STEP 1: Sign up — Supabase sends OTP email automatically
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) throw error;
      setMsg('Identity confirmed! Launching your workspace...');
      ...
      <div className="w-full max-w-sm bg-neutral-900/60 border border-neutral-800/60 rounded-3xl overflow-hidden backdrop-blur-sm">
        ...
        <div className="px-8 pt-8 pb-6 border-b border-neutral-800/50">
          ...
          <p className="text-sm text-neutral-500 leading-relaxed">
            ...
            {step === 'verify' && `We sent a 6-digit verification code to ${email}`}
          </p>
        </div>
        ...
        {step === 'signup' && (
          <form onSubmit={handleSignup} className="px-8 py-6 space-y-4">
            ...
            <div className="flex items-center gap-3"><div className="flex-1 h-px bg-neutral-800" /><span className="text-xs text-neutral-600 whitespace-nowrap">Already have access?</span><div className="flex-1 h-px bg-neutral-800" /></div>
        ...
        {step === 'verify' && (
          <form onSubmit={handleVerify} className="px-8 py-6 space-y-4">
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <button type="button" onClick={() => { setStep('signup'); setOtp(''); setMsg(''); }} className="text-neutral-500 hover:text-white transition-colors">
                ← Change email
              </button>
        ...
        {step === 'login' && (
          <form onSubmit={handleLogin} className="px-8 py-6 space-y-4">
            ...
            <div className="flex items-center gap-3"><div className="flex-1 h-px bg-neutral-800" /><span className="text-xs text-neutral-600 whitespace-nowrap">New to AI-BOS?</span><div className="flex-1 h-px bg-neutral-800" /></div>
